...
> = {
  chart: {
    ...
    results: [
      ...
      { label: "Confidence", value: "96%", highlight: true },
    ],
  ...
  nft: {
    ...
    results: [
      ...
      { label: "Trait: Head", value: "Gold Crown (0.3%)" },
      { label: "Trait: Eyes", value: "Laser Eyes (1.2%)" },
      { label: "Trait: Skin", value: "Diamond (0.8%)" },
      { label: "Floor Delta", value: "+340%", highlight: true },
  ...
  portrait: {
    ...
    results: [
      ...
      { label: "Styles Ready", value: "12 variants" },
      { label: "Confidence", value: "89%", highlight: true },
    ],
