      ...
      <div className="max-w-5xl mx-auto">
        ...
        <ScrollReveal className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-semibold tracking-tight mb-4">
            The <span className="gradient-text">{TOKEN.symbol}</span> Token
          </h2>
          <p className="text-base max-w-lg mx-auto leading-relaxed" style={{ color: "var(--text-tertiary)" }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <ScrollReveal direction="right">
            <div>
              <h3 className="text-xs uppercase tracking-widest mb-4" style={{ color: "var(--text-quaternary)" }}>Utility</h3>
        ...
        <ScrollReveal className="mt-12">
          <p className="text-[11px] leading-relaxed text-center max-w-2xl mx-auto" style={{ color: "var(--text-quaternary)" }}>
